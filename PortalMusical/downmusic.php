...
require_once("obtenerCanciones.php");
...
$_SESSION['invoiceDate'] = $fecha_compra;
...
<div class="card-body">
<?php
	require_once("mostrarCanciones.phtml");
?>
	</BR>
<?php
	echo '<div><input name="añadir" type="submit" value="Añadir Cancion" ></div>
	</form>';
