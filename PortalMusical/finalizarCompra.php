<?php
	try {
		...
		foreach($_SESSION['carrito'] as $producto) {
			...
			$sql = "INSERT INTO INVOICELINE (INVOICELINEID,INVOICEID,TRACKID,UNITPRICE) VALUES ('$invoiceLineId','$invoiceId','$trackId',$unitPrice)";
			$conn->exec($sql);
		...
		echo "<a href='main.php'>Volver a la Pagina Inicio</a>";
